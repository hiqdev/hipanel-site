...
<p>To configure a DNS in the <b><?= $options['host'] ?></b> panel, go to "DNS control" section and click on the "change DNS" button
    by highlighting
