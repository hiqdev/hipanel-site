...
<ol class="list-unstyled">
    <li>
        ...
        <p><img src="/www/img/help/transfer_from/domain/en/1.png" width="700"></p>
    </li>
    <li>
        <p class="list">In the "Domain" section, open the tab "Domain Central"</p>
        <p><img src="/www/img/help/transfer_from/domain/en/2.png" width="700"></p>
    </li>
    <li>
        <p class="list">Go to domain settings</p>
        <p><img src="/www/img/help/transfer_from/domain/en/3.png" width="700"></p>
    </li>
    <li>
        <p class="list">Open the "Transfer" tab, then click "Send Auth-Info code"</p>
        <p><img src="/www/img/help/transfer_from/domain/en/4.png" width="700"></p>
    </li>
    <li>
        <p class="list">Copy the code and start the transfer procedure on our site</p>
        <p><img src="/www/img/help/transfer_from/domain/en/5.png" width="700"></p>
    </li>
    <li>
