...
<ol class="list-unstyled">
    <li>
        ...
        <p><img src="<?= $options['imgDir'] ?>/help/transfer_from/godaddy/en/1.png" width="700"></p>
    </li>
    <li>
        <p class="list">Click on "Manage" next to "Domains" section.</p>
        <p><img src="<?= $options['imgDir'] ?>/help/transfer_from/godaddy/en/2.png" width="700"></p>
    </li>
    <li>
        <p class="list">Click on the domain that you want to transfer.</p>
        <p><img src="<?= $options['imgDir'] ?>/help/transfer_from/godaddy/en/3.png" width="700"></p>
    </li>
    <li>
        ...
        <p><img src="<?= $options['imgDir'] ?>/help/transfer_from/godaddy/en/4.png" width="700"></p>
    </li>
    <li>
        ...
        <p><img src="<?= $options['imgDir'] ?>/help/transfer_from/godaddy/en/5.png" width="700"></p>
    </li>
    <li>
        <p class="list">Copy domain code (for its further activation in our control panel).</p>
        <p><img src="<?= $options['imgDir'] ?>/help/transfer_from/godaddy/en/6.png" width="700"></p>
    </li>
    <li>
