...
<ol class="faq">
    <li>
        ...
        <p><img src="/www/img/help/transfer_from/directi/en/1.png" width="800" height="400"></p>
    </li>
    <li>
        <p class="list">Go to "Order Management", then select "List of orders".</p>
        <p><img src="/www/img/help/transfer_from/directi/en/2.png" width="800"></p>
    </li>
    <li>
        <p class="list">Click on the settings page for the required domain.</p>
        <p><img src="/www/img/help/transfer_from/directi/en/3.png" width="800"></p>
    </li>
    <li>
        <p class="list">Disable domain protection so you can proceed with the transfer.</p>
        <p><img src="/www/img/help/transfer_from/directi/en/4.png" width="800"></p>
        <p><img src="/www/img/help/transfer_from/directi/en/5.png" width="800"></p>
    </li>
    <li>
        <p class="list">Open the "Code for domain transfer".</p>
        <p><img src="/www/img/help/transfer_from/directi/en/6.png" width="800"></p>
    </li>
    <li>
        <p class="list">Copy the code and start the transfer procedure on our site.</p>
        <p><img src="/www/img/help/transfer_from/directi/en/7.png" width="800"></p>
    </li>
    <li>
    ...
    <li>
        ...
        <p><img src="/www/img/help/transfer_from/oursite/en/2.png" width="800"></p>
    </li>
    <li>
        ...
        <p><img src="/www/img/help/transfer_from/oursite/en/3.png" width="800"></p>
    </li>
    <li>
        <p class="list">Click on "Proceed"</p>
        <p><img src="/www/img/help/transfer_from/oursite/en/4.png" width="800"></p>
    </li>
    <li>
        <p class="list">At checkout, click on "Pay" button to pay for domain transfer and other operations</p>
        <p><img src="/www/img/help/transfer_from/oursite/en/5.png" width="800"></p>
    </li>
    <li>
        <p class="list">Select the payment method</p>
        <p><img src="/www/img/help/transfer_from/oursite/en/6.png" width="800"></p>
    </li>
