...
<p>Для начала работы с сервером необходимо создать аккаунт. Для этого, находясь в панели управления <?= $opt['host'] ?>,
...
<img style="display:inline-block; margin:10px 0" src="/www/img/faq/panelAHnames/qs1_ru.png" border="0">

<p>В появившемся окне заполните все необходимые формы и нажмите кнопку «Сохранить» в панели действий сверху.</p>
<img style="display:inline-block; margin:0 0 10px 0" src="/www/img/faq/panelAHnames/qs2_ru.png" border="0">
...
<img style="display:inline-block; margin:0 0 10px 0; display:block" src="/www/img/faq/panelAHnames/qs3_ru.png"
     border="0">
...
<img style="display:inline-block; margin:0 0 10px 0; display:block" src="/www/img/faq/panelAHnames/qs4_ru.png"
     border="0">
