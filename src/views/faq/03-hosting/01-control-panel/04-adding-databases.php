<?php
$this->title = 'Adding databases';
?>

<p>Select the "DB" field from the "Hosting panel" list. Click on "Create DB" in the action bar.</p>
<img style="display:block; margin:0 0 10px 0;" src="/www/img/faq/panelAHnames/qs8_en.png" border="0">
...
<img style="display:block; margin:0 0 10px 0;" src="/www/img/faq/panelAHnames/qs9_en.png" border="0">
