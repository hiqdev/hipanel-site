...
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/ru/macos1.png">
<p>Далее вводим свое имя, имя Вашего почтового ящика и пароль</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/ru/macos2.png">
...
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/ru/macos3.png">
<p>В конце выбираем приложение "Mail" , которое должно использовать данный аккаунт</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/ru/macos4.png">
