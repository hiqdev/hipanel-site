<?php
$this->title = 'Setting up Mail (Mac OS)';
?>
...
<img style="display:block; margin:0 0 10px 0;" border="0" src="<?= $options['imgDir'] ?>/faq/hosting/en/macos1.png">
<p>Then enter your name, e-mail address and password.</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="<?= $options['imgDir'] ?>/faq/hosting/en/macos2.png">
<p>In the manual config window set the connection parameters to the server as shown below: mail.connecting.name -
    ...
    as a username.</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="<?= $options['imgDir'] ?>/faq/hosting/en/macos3.png">
<p>In the end select "Mail" app that will be used with this account.</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="<?= $options['imgDir'] ?>/faq/hosting/en/macos4.png">
