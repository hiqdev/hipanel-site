<?php
$this->title = 'Setting up Outlook';
?>

<p>To configure the Outlook mail client for your mail server, start Outlook and click on the "File" tab in the main
    window.</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/en/outlook1.png">
<p>Click on "Add Account"</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/en/outlook2.png">
<p>Click <b>Manually configure server settings or additional server types</b>.</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/en/outlook3.png">
<p>"Internet E-mail" (Connect to POP or IMAP server to send and receive e-mail messages).</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/en/outlook4.png">
...
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/en/outlook5.png">
<p>If all goes well the following window will appear:</p>
<img style="display:block; margin:0 0 10px 0;" border="0" src="/www/img/faq/hosting/en/outlook6.png">
