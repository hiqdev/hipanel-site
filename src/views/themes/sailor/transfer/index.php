...
<div>
    <?php if (!Yii::$app->session->getFlash('transferGrid')) : ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <hr>
                <?= Html::submitButton('<i class="fa fa-paper-plane"></i>&nbsp;&nbsp;' . Yii::t('hipanel:domain', 'Transfer'), ['class' => 'btn btn-theme']); ?>
            </div>
            <div class="col-lg-6">
                <hr>
                <?= Html::submitButton('<i class="fa fa-paper-plane"></i>&nbsp;&nbsp;' . Yii::t('hipanel:domain', 'Bulk domain transfer'), ['class' => 'btn btn-theme']); ?>
            </div>
