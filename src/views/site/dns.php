        ...
        <div class="col-sm-4">
            <div class="pricing-plan absidian wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
                ...
                <div class="pricing-features">
                    <ul>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Free DNS-servers located in different data - centers: the Netherlands (NL) and the U.S. (US).') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Types of records available for editing: A, AAAA, MX, CNAME, TXT, NS') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Preinstalled settings for Google Apps') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Domain auto renewal option') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Working with subdomains') ?>
                        </li>
                        <li><span class="pull-right"><span
                                    class="text-success">1000</span></span><?= Yii::t('app', 'The total number of A and CName records') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'URL and E-mail forwarding') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Editing of SOA record') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Editing of TTL values') ?>
                        </li>
                        <li><span class="pull-right"><i
                                    class="fa fa-check text-success"></i></span><?= Yii::t('app', 'Domain parking') ?>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="difference">
        <div class="row spacing-25">
            ...
            <div class="col-md-9 col-sm-12 center-block">
                <div class="centered">
                    <p><?= Yii::t('hisite', '{domain} - an alphanumeric name that uniquely identifies a particular website.', ['domain' => Html::tag('b', Yii::t('app', 'Domain'))]) ?></p>
                    ...
                    <p><?= Yii::t('hisite', '{a} - a record that binds the hostname to an IP-address where the resource is located.', ['a' => Html::tag('b', Yii::t('app', 'А'))]) ?></p>
                    <p><?= Yii::t('hisite', '{aaaa} - a similar record that uses the address of the new Pv6 standard.', ['aaaa' => Html::tag('b', Yii::t('app', 'АААА'))]) ?></p>
                    <p><?= Yii::t('hisite', '{cname} - the canonical name or "alias" that is used to redirect requests from one domain name to another.', ['cname' => Html::tag('b', Yii::t('app', 'CNAME'))]) ?></p>
                    <p><?= Yii::t('hisite', '{mx} - a record that points to the IP-address of the mail server of a domain.', ['mx' => Html::tag('b', Yii::t('app', 'MX'))]) ?></p>
                    <p><?= Yii::t('hisite', '{ns} - indicates the IP-address of the DNS-server for this domain.', ['ns' => Html::tag('b', Yii::t('app', 'NS'))]) ?></p>
                    <p><?= Yii::t('hisite', '{txt} - indicates the IP-address that is used by the DNS-server of a domain.', ['txt' => Html::tag('b', Yii::t('app', 'TXT'))]) ?></p>
                    <p><?= Yii::t('hisite', '{soa} - a parameter that specifies which server stores the reference entry for your domain, stores the contact information and the caching information about the DNS-server interaction.', ['soa' => Html::tag('b', Yii::t('app', 'SOA'))]) ?></p>
                </div>
            </div>
