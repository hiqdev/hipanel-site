...
<p>
    We recommend that you read this Privacy Policy in full to ensure you are fully informed. If you have any questions about this Privacy Policy or Personal Data collection, Acceptable Use Policy, please contact Us at <?= Html::mailto(Yii::$app->params['gdprEmail']) ?>.
</p>
...
<p>
    You may inform Us of any withdrawal of consent in relation to any of the above purposes by giving notice of such withdrawal of consent to Our Data Protection Officer (<?= Html::mailto(Yii::$app->params['gdprEmail']) ?>). Upon and depending on the extent of such withdrawal of consent, We may not be in a position to continue providing you with some or all of Our services.
</p>
...
<ul>
    ...
    <li>If you wish to access, correct, update, or request deletion of your Personal Data, you can do so at any time by emailing <?= Html::mailto(Yii::$app->params['gdprEmail']) ?></a></li>
    <li>In addition, you can object to the processing of your Personal Data, ask Us to restrict the processing of your Personal Data, or request portability of your Personal Data. You can exercise these rights by emailing <?= Html::mailto(Yii::$app->params['gdprEmail']) ?></a></li>
    <li>You have the right to opt-out of marketing communications We send you at any time. You can exercise this right by clicking on the "unsubscribe" or "opt-out" link in the marketing emails We send you. To opt-out of other forms of marketing, please contact Us by emailing <?= Html::mailto(Yii::$app->params['gdprEmail']) ?></a></li>
...
<p>
    We don’t knowingly collect information from persons under the age of 18, and person under 18 are prohibited from using Our Services. If you learn that a child has provided Us with Personal Information or Data in violation of this Privacy Policy, you can alert Us at <?= Html::mailto(Yii::$app->params['gdprEmail']) ?></a>.
</p>
...
<p>
    We reserve the right to change the Privacy policy, and will post any revisions on Out website <?= Yii::$app->params['organization.name'] ?>. We advise you to check this page regularly to see if any changes have been implemented.
</p>

<h5>Contact Us</h5>
<p>
    If you have any questions or concerns about this Privacy Policy, please feel free to email Us at <?= Html::mailto(Yii::$app->params['gdprEmail']) ?></a>.
</p>
