...
<p>The following information may be disclosed:</p>

<ul>
    <li>Domain names registered on your name;</li>
    <li>
    ...
    <li>Internet protocol (IP) addresses and name server (NS) hosts for each registered domain name;</li>
    <li>The corresponding names of those name servers;</li>
    <li>The date of domain registration;</li>
    <li>The date on which the registration expires.</li>
</ul>
