<table class="table table-bordered server-products-table">
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                ...
                <li><b>period</b> — period — defaults to: 1 year</li>
    ...
    <tr>
        ...
        <td>Check data for domain transfer</td>
        <td class="left_column">
            <ul>
                <li><b>domain</b> — domain, *</li>
    ...
    <tr>
        ...
        <td>Check data for domains transfer</td>
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainCheckTransfer</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainTransfer</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainGetNSs</li>
            </ul>
        </td>
    </tr>
    <tr>
        <th>domainSetNSs</th>
        <td>Set name servers for the domain</td>
        <td class="left_column">
            <ul>
                <li><b>domain</b> — domain</li>
                <li><b>nss</b> — nss</li>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainSetNSs</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainGetNote</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainGetPassword</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainRegenPassword</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> — domainGetContacts</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> — domainGetContactsInfo</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainGetContacts</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainSetContacts</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> — domainEnableAutorenewal</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainEnableAutorenewal</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> — domainEnableWhoisProtect</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainEnableWhoisProtect</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> — domainEnableLock</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainEnableLock</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — domainGetDNS</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — hdomainGetDNS</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — hostGetInfo</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — contactGetInfo</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                ...
                <li><b>type</b> — ref — one of: person, organization</li>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — contactCreate</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — contactUpdate</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — contactDelete</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> — clientGetPrices</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            ...
            <ul>
                <li><b>type</b> - ref (one of: domain, ovds, svds)</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - tariffGetInfo</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverGetList</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverGetInfo</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                ...
                <li><b>osimage</b> - eid,* (available values can be obtained with command <b>osimagesSearch</b>)
                </li>
                <li><b>panel</b> - ref</li>
                <li><b>social</b> - label</li>
                <li><b>purpose</b> - label</li>
                <li><b>callback_url</b> - url</li>
                <li><b>amount</b> - id, period, default 1</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverRenew</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverReboot</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverReset</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverShutdown</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverPowerOn</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverPowerOff</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>id</b> - id</li>
                <li><b>server</b> - server</li>
                <li><b>osimage</b> - eid,* (see <b>serverBuy</b>)</li>
                <li><b>panel</b> - ref (see <b>serverBuy</b>)</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverResetup</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverEnableVNC</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverRegenRootPassword</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>Boot server from Live CD</td>
        <td class="left_column">
            <ul>
                <li><b>id</b> - id</li>
                <li><b>server</b> - server</li>
                <li><b>osimage</b> - eid (one of: freebsdx64.live, gentoox64.live)</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> - serverBootLive</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>type</b> - ref (one of: svds - XEN, ovds - OpenVZ)</li>
            </ul>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateGetInfo</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificatesGetData</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificatePurchase</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateIssue</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> certificateIssue</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateReissue</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateCancel</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateRenew</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> certificateGenerateCSR</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>same as</b> certificateDecodeCSR</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateSendNotifications</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificateRevalidate</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>id</b> - id, *</li>
                <li><b>dcv_method</b> - ref, * (available values: dns, http, https, email)</li>
                <li><b>approver_email</b> - email</li>
                <li><b>approver_emails</b> - emails</li>
    ...
    <tr>
        ...
        <td class="left_column">
            <ul>
                <li><b>array of</b> certificatesRevalidate</li>
            </ul>
        </td>
    </tr>
    </tbody>
