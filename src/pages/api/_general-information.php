...
<ul>
    ...
    <li>API run-time version is available and can be found at <b>https://hiapi.ahnames.com</b>
        respectively;
    </li>
    <li>Requests are sent over <b>https://hiapi.ahnames.com/apiCommand</b>. Request data are transferred via GET or
        POST variables;
    </li>
